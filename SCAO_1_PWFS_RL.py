...
sample_shape = env.DM_pyr.nValidAct
...
def main():
    ...
    directory_name = 'test' #should train on onliseed 5 and continue evaluating on seed 5 (noiseless)
    directory_name_load_buffer = 'test_PWFS_nonparallel_update_noise_1000Hz'
