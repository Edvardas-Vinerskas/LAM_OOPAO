...
from PAPYRIIS_2stage_CNN_RL.PAPYRUS.compute_papytwin import compute_papyrus_model
...
class Papyrus:
    ...
    def __init__(self):
        ...
        self.tel,self.ngs,self.dm,self.wfs,self.atm,self.slow_tt,self.perfect_OCAM,self.OCAM = compute_papyrus_model(param = self.param, loc = loc, source=True, IFreal=False)
